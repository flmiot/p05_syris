...
# === LENS ===
lens = Lens(20, f_number=1.4, focal_length=50 * q.mm, transmission_eff=0.5, sigma=None)
# === SCINTILLATOR ===
...
fltr = GaussianFilter(energies, energy * q.eV, sigma,  peak_transmission = 0.1)
...
# === MAKE EXPERIMENT ===
ex = SteppedTomography2( [undu, fltr, cb], cb, undu, detector, [53.455,32.477,5] * q.m, energies)
