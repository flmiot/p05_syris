...
from syris.devices.cameras import make_ehd_sc09000
...
OUTPUT = '/home/ubuntu/ownCloud/syris/simdata/raw/ph_resolution_01'
OBJ_PATH = 'ph_resolution.obj'
NO_OF_IMAGES = 360
THETA_MIN = 0
THETA_MAX = 180
START_I = 0
...
# === LENS ===
lens = Lens(5, f_number=1.4, focal_length=50 * q.mm, transmission_eff=0.5, sigma=None)
# === SCINTILLATOR ===
...
# === MAKE EXPERIMENT ===
ex = SteppedTomography2( [undu, fltr, art, cb], cb, undu, detector, [53.455,0,32.477,0] * q.m, energies)
