...
syris.init( platform_name = 'NVIDIA CUDA', device_index = 1, double_precision = False )
...
# === MAKE EXPERIMENT ===
ex = PetraExperiment( [bm, cb], bm, detector, 0 * q.cm, energies)   
